...
const projects = [
  ...
  { name: "AI Opportunity Finder", type: "Business strategy", status: "Built", href: "https://aioppfind.thepointsolutions.com/", description: "A fast assessment that helps businesses identify where AI can create the greatest practical impact.", tags: ["AI strategy", "Assessment", "Opportunities"] },
  { name: "Solo Content Studio", type: "Content automation", status: "Prototype", href: "/studio", description: "A personal workspace for creating, adapting, previewing, and scheduling social content across channels.", tags: ["Social content", "Scheduling", "Automation"] },
